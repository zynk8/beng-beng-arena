...
var Defaults = {
    DefaultBitmapTextNodes: require('./DefaultBitmapTextNodes'),
    ...
    DefaultTilemapLayerNodes: require('./DefaultTilemapLayerNodes'),
    DefaultTileSpriteNodes: require('./DefaultTileSpriteNodes')
};
